...
(function () {
  ...
  // app.js рисует страницу раньше, чем браузер доходит до этого файла, и на
  // вкладке «Подключение» успевает показать заглушку «setup.js не загрузился».
  // Раз мы здесь — значит загрузился; перерисовываем.
